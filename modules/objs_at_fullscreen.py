...
class OBJs_1(Gtk.Box): 
    ...
    def __init__(self, pt):
        ...
        btn_apply.connect('clicked', self.pt.tool_bar.apply_added)
        ...
        btn_help.connect('clicked', self.pt.tool_bar.help_me_letters)
        ...
        btn_undo.connect('clicked', self.pt.tool_bar.undo_added)
        ...
        btn_no_play.connect('clicked', self.pt.tool_bar.skip_2_computer)
        ...
        btn_change.connect('clicked', self.pt.tool_bar.change_my_letters)
