...
data_files = [
	      ...
	      ('share/GScrabble/modules', glob('modules/*.py')),
              ...
              ('share/GScrabble/locale/de/LC_MESSAGES/', ['locale/de/LC_MESSAGES/gscrabble.mo']),
              ('share/GScrabble/locale/en/LC_MESSAGES/', ['locale/en/LC_MESSAGES/gscrabble.mo']),
              ('share/GScrabble/locale/es/LC_MESSAGES/', ['locale/es/LC_MESSAGES/gscrabble.mo']),
	      ('share/GScrabble/locale/fr/LC_MESSAGES/', ['locale/fr/LC_MESSAGES/gscrabble.mo']),
	      ('share/GScrabble/locale/it/LC_MESSAGES/', ['locale/it/LC_MESSAGES/gscrabble.mo']),
